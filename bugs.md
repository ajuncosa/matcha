...
- [X] In the edit profile dialog, in preferences, you cannot erase and re-write the min/max age, it's validated and overwritten with the minimum before the user manually saves
    - [X] Same in search page
    - [X] Same in browser > Filter
...
- [X] If a user is not currently online, sett the date and time of their last connection in the profile page
- [X] Reported users don't appear in the reported Users table in the DB
